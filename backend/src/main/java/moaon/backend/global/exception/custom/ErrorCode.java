...
public enum ErrorCode {
    ...
    HTTP_METHOD_NOT_SUPPORTED("GLOBAL-004", "지원하지 않는 HTTP 메소드입니다.", HttpStatus.BAD_REQUEST),
    TYPE_MISMATCH("GLOBAL-005", "요청 데이터의 자료형이 일치하지 않습니다. 경로 변수, 쿼리 파라미터, 요청 본문을 확인해 주세요.", HttpStatus.BAD_REQUEST),
